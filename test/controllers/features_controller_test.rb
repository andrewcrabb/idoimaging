...
class FeaturesControllerTest < ActionController::TestCase
  ...
  test "should create feature" do
    assert_difference('Feature.count') do
      post :create, feature: { description: @feature.description, name: @feature.name, value: @feature.value }
    end
  ...
  test "should update feature" do
    patch :update, id: @feature, feature: { description: @feature.description, name: @feature.name, value: @feature.value }
    assert_redirected_to feature_path(assigns(:feature))
  end
